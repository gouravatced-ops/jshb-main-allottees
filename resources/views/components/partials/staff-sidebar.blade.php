@if($sidebarUser?->role === 'staff')
<div class="nav-item-wrap">
    <a class="nav-link-custom {{ request()->routeIs('staff.dashboard') ? 'active' : '' }}" href="{{ route('staff.dashboard') }}">
...
<div class="nav-item-wrap">
    <a class="nav-link-custom {{ request()->routeIs('staff.profile') ? 'active' : '' }}" href="{{ route('staff.profile') }}">
