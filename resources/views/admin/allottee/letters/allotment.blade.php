    ...
    <div class="card border-0 shadow-sm">
         ...
         ">
            <div class="d-flex justify-content-between align-items-center flex-wrap gap-2">
                ...
                <div class="d-flex flex-wrap gap-1">
                    {{-- Back --}}
                    <a href="#" onclick="event.preventDefault(); loadStep(2);" class="btn btn-dark btn-sm px-3">
                    ...
                    {{-- Preview --}}
                    <a href="{{ route('admin.allottees.letters.allotment.pdf', ['allottee' => $allottee]) }}"
        ...
        <div class="card-body bg-light p-2">
            <div class="border rounded bg-white overflow-hidden">
                <iframe id="pdfFrame" src="{{ route('admin.allottees.letters.allotment.pdf', ['allottee' => $allottee]) }}"
                    style="width:100%; height:82vh; border:0;" title="Allotment Letter PDF">
                </iframe>
            </div>
        </div>
    </div>
