    ...
    <div class="page-header">
        <div>
            ...
            <p class="page-subtitle">
                {{ rtrim(rtrim($payment->percentage, '0'), '.') }}% One Time Payment Collection
            </p>
        </div>
    </div>
    @if ($payment)
        <div class="row g-3">
            ...
            <div class="col-md-4">
                <div class="info-card">
                    ...
                    <p class="info-card-value">
                        {{ rtrim(rtrim($payment->percentage, '0'), '.') }} %
                    </p>
                </div>
            </div>
            <!-- BASE AMOUNT -->
            ...
            <!-- DELAY DAYS -->
            @if (isset($payment->delay_days) && $payment->delay_days > 0)
                <div class="col-md-4">
                    <div class="info-card">
                        <p class="info-card-label">
                            Delay Days
                        ...
                        <p class="info-card-value text-danger">
                            {{ round($payment->delay_days) ?? 0 }} Days
                        </p>
                    </div>
                </div>
            @endif
            ...
            <!-- PENALTY PERCENTAGE -->
            @if (isset($payment->penalty_percentage) && $payment->penalty_percentage > 0)
                <div class="col-md-4">
                    <div class="info-card">
                        <p class="info-card-label">
                            Penalty Percentage
