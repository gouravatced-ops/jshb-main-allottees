            ...
            <div class="card border-0 mb-4" style="box-shadow: 0 4px 15px rgba(0,0,0,0.05); border-radius: 12px; overflow: hidden;">
                <div class="card-body p-0">
                    <div class="d-flex justify-content-between align-items-center p-3 px-4 bg-light border-bottom">
                        <h6 class="fw-bold mb-0 text-dark"><i class="fa-solid fa-bell text-warning me-2"></i>Notices & Notifications</h6>
                        <a href="{{ route('dashboard.section', ['blade' => 'notifications']) }}" class="btn btn-sm btn-outline-secondary py-0" style="font-size: 12px;">View All</a>
                    </div>
                    <div class="list-group list-group-flush">
                        @php
                        $dashboardNotifications = \App\Models\Notification::where('user_id', auth()->id())
                        ...
                        <div class="list-group-item p-4 text-center text-muted">
                            ...
                            <p class="mb-0 small">No recent notices or announcements.</p>
                        </div>
                        @endforelse
                    </div>
                </div>
