                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            ...
                            <a href="{{ route('media.document', ['path' => rtrim(config('app.doc_api_url', 'http://localhost/jshb-doc'), '/') . '/' . ltrim($agreementDocument->file_path, '/')]) }}" target="_blank" class="btn btn-sm btn-outline-primary mb-1 d-block" title="Download Agreement">
